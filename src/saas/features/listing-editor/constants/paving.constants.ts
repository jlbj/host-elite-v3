import type { SectionType, Theme, Layout, SectionContent, SectionLibraryItem } from '../models/paving.types';
...
export const THEMES: Theme[] = [
  {
    ...
    spacing: { sectionPadding: '4rem 2rem', gap: '2rem' },
    borders: { radius: '0.5rem', style: 'solid', width: '1px' },
    buttons: { shape: 'rounded', variant: 'filled', shadow: 'sm' },
    animations: { hover: 'scale', scroll: 'fade-up', speed: '300ms' },
  },
  {
    id: 'elegant-gold',
    name: 'Elegant Gold',
    ...
    spacing: { sectionPadding: '3.5rem 2rem', gap: '2rem' },
    borders: { radius: '4px', style: 'solid', width: '1px' },
    buttons: { shape: 'rounded', variant: 'filled', shadow: 'sm' },
    animations: { hover: 'lift', scroll: 'fade-up', speed: '400ms' },
  },
  {
    id: 'tropical-green',
    name: 'Tropical Green',
    ...
    spacing: { sectionPadding: '3rem 1.5rem', gap: '1.5rem' },
    borders: { radius: '8px', style: 'solid', width: '2px' },
    buttons: { shape: 'pill', variant: 'filled', shadow: 'md' },
    animations: { hover: 'scale', scroll: 'fade-in', speed: '300ms' },
  },
  {
    id: 'luxury-black',
    name: 'Luxury Black',
    ...
    spacing: { sectionPadding: '4rem 3rem', gap: '2rem' },
    borders: { radius: '2px', style: 'solid', width: '1px' },
    buttons: { shape: 'square', variant: 'outline', shadow: 'none' },
    animations: { hover: 'glow', scroll: 'fade-up', speed: '500ms' },
  },
  {
    id: 'coastal-blue',
    name: 'Coastal Blue',
    ...
    spacing: { sectionPadding: '3rem 2rem', gap: '1.5rem' },
    borders: { radius: '12px', style: 'solid', width: '1px' },
    buttons: { shape: 'rounded', variant: 'filled', shadow: 'md' },
    animations: { hover: 'lift', scroll: 'fade-in', speed: '350ms' },
  },
  {
    id: 'warm-terracotta',
    ...
    spacing: { sectionPadding: '3.5rem 2rem', gap: '2rem' },
    borders: { radius: '6px', style: 'solid', width: '2px' },
    buttons: { shape: 'rounded', variant: 'filled', shadow: 'sm' },
    animations: { hover: 'scale', scroll: 'fade-up', speed: '300ms' },
  },
  {
    ...
    spacing: { sectionPadding: '3rem 1.5rem', gap: '1.5rem' },
    borders: { radius: '0', style: 'solid', width: '1px' },
    buttons: { shape: 'square', variant: 'filled', shadow: 'none' },
    animations: { hover: 'none', scroll: 'fade-in', speed: '200ms' },
  },
  {
    id: 'warm-sunset',
    name: 'Warm Sunset',
    ...
    spacing: { sectionPadding: '4rem 2rem', gap: '2rem' },
    borders: { radius: '0.75rem', style: 'solid', width: '2px' },
    buttons: { shape: 'pill', variant: 'filled', shadow: 'md' },
    animations: { hover: 'lift', scroll: 'fade-up', speed: '400ms' },
  },
];
...
export const DEFAULT_SECTION_TYPES: readonly SectionType[] = ['hero', 'description', 'photos', 'contact'] as const;
